...
u32 sSecretPowerEffectTable[] = {
    ...
    [TERRAIN_KOGA] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_BRUNO] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_KAREN] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_LANCE] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_DISTORTION_WORLD] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_BATTLE_TOWER] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_BATTLE_FACTORY] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_BATTLE_ARCADE] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_BATTLE_CASTLE] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_BATTLE_HALL] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_GIRATINA] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_ELECTRIC_TERRAIN] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_PARALYZE,
    [TERRAIN_MISTY_TERRAIN] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_SP_ATTACK_DOWN_1_STAGE,
    [TERRAIN_GRASSY_TERRAIN] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_SLEEP,
    [TERRAIN_PSYCHIC_TERRAIN] = MOVE_SIDE_EFFECT_TO_DEFENDER | MOVE_SUBSCRIPT_PTR_SPEED_DOWN_1_STAGE,
};
