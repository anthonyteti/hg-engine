...
def build_inventory(root: Path = ROOT, revision: str | None = None) -> dict[str, Any]:
    ...
    inventory = {
        ...
        "selected_expanded_species_proof": {
            ...
            "selection_reason": "first post-Gen-4 identity with direct data, complete render assets, cry, Dex number/name/sprite/seen-caught support, and follower mappings; expanded Dex category/description and runtime paths remain unresolved",
            ...
            "runtime_status": "PARTIAL_EXECUTED",
            "runtime_evidence": [
                ...
                "ordinary PC box deposit with species/form/level/move preservation",
            ],
            "runtime_blocker": "battle runner lacks ignored test.sav; shared controlled-entry route blocks trainer, wild/capture, icon UI, transition, and hard-reset/Continue completion",
        },
        "records": records,
    }
    return inventory
