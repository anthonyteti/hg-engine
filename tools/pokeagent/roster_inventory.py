...
def build_inventory(root: Path = ROOT, revision: str | None = None) -> dict[str, Any]:
    ...
    inventory = {
        ...
        "selected_expanded_species_proof": {
            ...
            "runtime_blocker": "generic harness recovered; ordinary wild/capture, trainer-NARC loading, party/PC icon UI, cry routing, and native follower transition remain unexecuted",
        },
        "records": records,
    }
    return inventory
