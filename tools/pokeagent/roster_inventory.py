...
def build_inventory(root: Path = ROOT, revision: str | None = None) -> dict[str, Any]:
    ...
    inventory = {
        ...
        "selected_expanded_species_proof": {
            ...
            "runtime_blocker": "no existing deterministic QA route exercises battle, party, PC, save/reset/Continue, trainer, wild, and follower paths without adding gameplay content",
        },
        "records": records,
    }
    return inventory
